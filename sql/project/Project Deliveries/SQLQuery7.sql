...
/****** Object:  StoredProcedure [dbo].[StudentModelAnswer]    Script Date: 9/3/2023 2:25:17 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRY
    ...
    ELSE
        BEGIN
			...
			SET @TotalCorrectAnswers = CAST(@TotalCorrectAnswers AS DECIMAL(5, 2));
			SET @QuestNombers = CAST(@QuestNombers AS DECIMAL(5, 2));
